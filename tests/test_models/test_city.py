...
class TestCitySave(unittest.TestCase):
    """Test cases for save method of the City class"""
...
class TestCityToDict(unittest.TestCase):
    """Test cases for to_dict method of the City class"""
    ...
    def test_to_dict_contains_added_attributes(self):
        city = City()
        city.middle_name = "Lagos"
        city.my_number = 98
        self.assertEqual("Lagos", city.middle_name)
